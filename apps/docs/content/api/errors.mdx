...
Anything outside your credential's limits answers `not_found`, exactly as if it did not exist. If you get a 404 for an ID you know is right, check the key's access with `GET /users/whoami`.
