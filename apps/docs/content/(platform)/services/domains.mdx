...
A request with a body larger than 100 MB, like a big file upload, is refused with `413 Request Entity Too Large`. To change it, set **Max Request Size** at the bottom of **Networking** in the service settings, anywhere from 1 MB to 10240 MB, and deploy. Clear the field to go back to 100 MB.
