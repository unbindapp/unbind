...
- **Create databases**: PostgreSQL, MySQL, Redis, ClickHouse and others run next to your services, with backups to S3 compatible storage.
...
- **Work as a team**: Invite people and decide which teams, projects and environments they can reach.
