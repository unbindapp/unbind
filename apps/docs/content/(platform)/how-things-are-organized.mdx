...
A team is the top level. It holds projects, members and the settings they share, like S3 storage and webhooks.

- **Members**: People are invited to a team and can be limited to certain projects or environments. See [Members and Permissions](/teams/members-and-permissions).
...
- **Shared settings**: A project has its own variables, webhooks and members.
...
<Callout title="Changing a service does not roll it out">
  When you edit a service, the change waits until the next deployment. This lets you change several
  things and roll them out together.
</Callout>
