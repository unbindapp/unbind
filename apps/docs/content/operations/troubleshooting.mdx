...
- **A deployment stays QUEUED**: other builds are ahead of it, or the registry is deleting old images to free space. Two builds run at a time by default. See [System Settings](/operations/system-settings#builds).
