...
func RegisterHandlers(server *server.Server, grp *huma.Group) {
	...
	oapi.Register(grp, oapi.Delete, huma.Operation{
		...
		Description: "Permanently delete a service, its deployments, and its config. Mounted volumes are not deleted, they remain in the environment and can be mounted on another service. If it was the last service in its service group, the group is deleted too.",
		Path:        "/delete",
