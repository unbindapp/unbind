...
type LogStreamInput struct {
	...
	Limit         int64     `query:"limit" default:"2000" minimum:"1" maximum:"2000" doc:"Number of lines to get from the end (mirrors loki.MaxQueryLimit)"`
...
type LogQueryInput struct {
	...
	Limit         int                `query:"limit" default:"2000" minimum:"1" maximum:"2000" doc:"Number of log lines to get (mirrors loki.MaxQueryLimit)"`
