...
type APIKeyCreateInput struct {
	...
	Privileges []schema.KeyPrivilege   `json:"privileges,omitempty" required:"false" nullable:"false" doc:"What the key may see beyond its role: read_variable_values, read_logs, read_webhook_urls. All off when omitted."`
}
