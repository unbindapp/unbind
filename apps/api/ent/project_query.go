...
func (_q *ProjectQuery) QueryTeam() *TeamQuery {
...
func (_q *ProjectQuery) QueryDefaultEnvironment() *EnvironmentQuery {
	query := (&EnvironmentClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *ProjectQuery) QueryProjectWebhooks() *WebhookQuery {
...
func (_q *ProjectQuery) Clone() *ProjectQuery {
	...
	return &ProjectQuery{
		...
		withDefaultEnvironment: _q.withDefaultEnvironment.Clone(),
		withProjectWebhooks:    _q.withProjectWebhooks.Clone(),
...
func (_q *ProjectQuery) WithTeam(opts ...func(*TeamQuery)) *ProjectQuery {
	query := (&TeamClient{config: _q.config}).Query()
...
func (_q *ProjectQuery) WithDefaultEnvironment(opts ...func(*EnvironmentQuery)) *ProjectQuery {
	query := (&EnvironmentClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withDefaultEnvironment = query
	return _q
}
...
func (_q *ProjectQuery) WithProjectWebhooks(opts ...func(*WebhookQuery)) *ProjectQuery {
	query := (&WebhookClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withProjectWebhooks = query
	return _q
}
...
func (_q *ProjectQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Project, error) {
	var (
		...
		loadedTypes = [4]bool{
			...
			_q.withDefaultEnvironment != nil,
			_q.withProjectWebhooks != nil,
		}
	)
	...
	if query := _q.withDefaultEnvironment; query != nil {
		if err := _q.loadDefaultEnvironment(ctx, query, nodes, nil,
			func(n *Project, e *Environment) { n.Edges.DefaultEnvironment = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withProjectWebhooks; query != nil {
		if err := _q.loadProjectWebhooks(ctx, query, nodes,
...
func (_q *ProjectQuery) loadTeam(ctx context.Context, query *TeamQuery, nodes []*Project, init func(*Project), assign func(*Project, *Team)) error {
...
func (_q *ProjectQuery) loadDefaultEnvironment(ctx context.Context, query *EnvironmentQuery, nodes []*Project, init func(*Project), assign func(*Project, *Environment)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*Project)
	for i := range nodes {
...
func (_q *ProjectQuery) loadProjectWebhooks(ctx context.Context, query *WebhookQuery, nodes []*Project, init func(*Project), assign func(*Project, *Webhook)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Project)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
...
func (_q *ProjectQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withDefaultEnvironment != nil {
