...
func (_q *TemplateQuery) QueryServices() *ServiceQuery {
...
func (_q *TemplateQuery) WithServices(opts ...func(*ServiceQuery)) *TemplateQuery {
	query := (&ServiceClient{config: _q.config}).Query()
...
func (_q *TemplateQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Template, error) {
	...
	if query := _q.withServices; query != nil {
		if err := _q.loadServices(ctx, query, nodes,
			func(n *Template) { n.Edges.Services = []*Service{} },
			func(n *Template, e *Service) { n.Edges.Services = append(n.Edges.Services, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *TemplateQuery) loadServices(ctx context.Context, query *ServiceQuery, nodes []*Template, init func(*Template), assign func(*Template, *Service)) error {
	...
	query.Where(predicate.Service(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(template.ServicesColumn), fks...))
	}))
