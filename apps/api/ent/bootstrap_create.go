...
func (_c *BootstrapCreate) SetIsBootstrapped(v bool) *BootstrapCreate {
	_c.mutation.SetIsBootstrapped(v)
	return _c
}

// Mutation returns the BootstrapMutation object of the builder.
func (_c *BootstrapCreate) Mutation() *BootstrapMutation {
	return _c.mutation
}

// Save creates the Bootstrap in the database.
func (_c *BootstrapCreate) Save(ctx context.Context) (*Bootstrap, error) {
	return withHooks(ctx, _c.sqlSave, _c.mutation, _c.hooks)
}

// SaveX calls Save and panics if Save returns an error.
func (_c *BootstrapCreate) SaveX(ctx context.Context) *Bootstrap {
	v, err := _c.Save(ctx)
	if err != nil {
		panic(err)
	}
...
func (_c *BootstrapCreate) Exec(ctx context.Context) error {
	_, err := _c.Save(ctx)
	return err
}

// ExecX is like Exec, but panics if an error occurs.
func (_c *BootstrapCreate) ExecX(ctx context.Context) {
...
func (_c *BootstrapCreate) check() error {
	if _, ok := _c.mutation.IsBootstrapped(); !ok {
		return &ValidationError{Name: "is_bootstrapped", err: errors.New(`ent: missing required field "Bootstrap.is_bootstrapped"`)}
	}
	return nil
}

func (_c *BootstrapCreate) sqlSave(ctx context.Context) (*Bootstrap, error) {
...
func (_c *BootstrapCreate) createSpec() (*Bootstrap, *sqlgraph.CreateSpec) {
	var (
		_node = &Bootstrap{config: _c.config}
		_spec = sqlgraph.NewCreateSpec(bootstrap.Table, sqlgraph.NewFieldSpec(bootstrap.FieldID, field.TypeInt))
	)
	_spec.OnConflict = _c.conflict
	if value, ok := _c.mutation.IsBootstrapped(); ok {
...
//		}).
//		Exec(ctx)
func (_c *BootstrapCreate) OnConflict(opts ...sql.ConflictOption) *BootstrapUpsertOne {
	_c.conflict = opts
...
//		Exec(ctx)
func (_c *BootstrapCreate) OnConflictColumns(columns ...string) *BootstrapUpsertOne {
...
func (_c *BootstrapCreateBulk) Save(ctx context.Context) ([]*Bootstrap, error) {
	if _c.err != nil {
		return nil, _c.err
	}
	specs := make([]*sqlgraph.CreateSpec, len(_c.builders))
	nodes := make([]*Bootstrap, len(_c.builders))
...
func (_c *BootstrapCreateBulk) SaveX(ctx context.Context) []*Bootstrap {
	v, err := _c.Save(ctx)
	if err != nil {
		panic(err)
	}
...
// Exec executes the query.
func (_c *BootstrapCreateBulk) Exec(ctx context.Context) error {
	_, err := _c.Save(ctx)
	return err
}

// ExecX is like Exec, but panics if an error occurs.
func (_c *BootstrapCreateBulk) ExecX(ctx context.Context) {
	if err := _c.Exec(ctx); err != nil {
		panic(err)
	}
}
...
//		}).
//		Exec(ctx)
func (_c *BootstrapCreateBulk) OnConflict(opts ...sql.ConflictOption) *BootstrapUpsertBulk {
	_c.conflict = opts
...
//		OnConflict(sql.ConflictColumns(columns...)).
//		Exec(ctx)
func (_c *BootstrapCreateBulk) OnConflictColumns(columns ...string) *BootstrapUpsertBulk {
	_c.conflict = append(_c.conflict, sql.ConflictColumns(columns...))
	return &BootstrapUpsertBulk{
		create: _c,
	}
