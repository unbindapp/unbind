...
func (_c *UserCreate) AddOauth2TokenIDs(ids ...uuid.UUID) *UserCreate {
	_c.mutation.AddOauth2TokenIDs(ids...)
	return _c
}

// AddOauth2Tokens adds the "oauth2_tokens" edges to the Oauth2Token entity.
func (_c *UserCreate) AddOauth2Tokens(v ...*Oauth2Token) *UserCreate {
...
func (_c *UserCreate) AddCreatedByIDs(ids ...int64) *UserCreate {
	_c.mutation.AddCreatedByIDs(ids...)
	return _c
}

// AddCreatedBy adds the "created_by" edges to the GithubApp entity.
func (_c *UserCreate) AddCreatedBy(v ...*GithubApp) *UserCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddCreatedByIDs(ids...)
}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.Oauth2TokensIDs(); len(nodes) > 0 {
