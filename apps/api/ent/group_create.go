...
func (_c *GroupCreate) SetK8sRoleName(v string) *GroupCreate {
	_c.mutation.SetK8sRoleName(v)
	return _c
}

// SetNillableK8sRoleName sets the "k8s_role_name" field if the given value is not nil.
func (_c *GroupCreate) SetNillableK8sRoleName(v *string) *GroupCreate {
	if v != nil {
		_c.SetK8sRoleName(*v)
	}
	return _c
...
func (_c *GroupCreate) AddPermissionIDs(ids ...uuid.UUID) *GroupCreate {
...
func (_c *GroupCreate) createSpec() (*Group, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.K8sRoleName(); ok {
