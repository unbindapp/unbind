...
func (_u *APIKeyUpdate) SetTokenPrefix(v string) *APIKeyUpdate {
	_u.mutation.SetTokenPrefix(v)
	return _u
}

// SetNillableTokenPrefix sets the "token_prefix" field if the given value is not nil.
func (_u *APIKeyUpdate) SetNillableTokenPrefix(v *string) *APIKeyUpdate {
	if v != nil {
		_u.SetTokenPrefix(*v)
	}
	return _u
...
// SetTokenPrefix sets the "token_prefix" field.
func (_u *APIKeyUpdateOne) SetTokenPrefix(v string) *APIKeyUpdateOne {
	_u.mutation.SetTokenPrefix(v)
	return _u
}

// SetNillableTokenPrefix sets the "token_prefix" field if the given value is not nil.
func (_u *APIKeyUpdateOne) SetNillableTokenPrefix(v *string) *APIKeyUpdateOne {
	if v != nil {
		_u.SetTokenPrefix(*v)
	}
	return _u
