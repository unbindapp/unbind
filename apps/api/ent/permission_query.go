...
func (_q *PermissionQuery) QueryGroups() *GroupQuery {
...
func (_q *PermissionQuery) WithGroups(opts ...func(*GroupQuery)) *PermissionQuery {
	query := (&GroupClient{config: _q.config}).Query()
...
func (_q *PermissionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Permission, error) {
	...
	if query := _q.withGroups; query != nil {
		if err := _q.loadGroups(ctx, query, nodes,
			func(n *Permission) { n.Edges.Groups = []*Group{} },
			func(n *Permission, e *Group) { n.Edges.Groups = append(n.Edges.Groups, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *PermissionQuery) loadGroups(ctx context.Context, query *GroupQuery, nodes []*Permission, init func(*Permission), assign func(*Permission, *Group)) error {
	...
	query.Where(func(s *sql.Selector) {
		...
		s.Join(joinT).On(s.C(group.FieldID), joinT.C(permission.GroupsPrimaryKey[0]))
