...
// CreateApp provides a mock function with given fields: ctx, uniqueUuid, app, createdBy
func (_m *GithubRepositoryMock) CreateApp(ctx context.Context, uniqueUuid uuid.UUID, app *github.AppConfig, createdBy uuid.UUID) (*ent.GithubApp, error) {
	ret := _m.Called(ctx, uniqueUuid, app, createdBy)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, *github.AppConfig, uuid.UUID) (*ent.GithubApp, error)); ok {
		return rf(ctx, uniqueUuid, app, createdBy)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, *github.AppConfig, uuid.UUID) *ent.GithubApp); ok {
		r0 = rf(ctx, uniqueUuid, app, createdBy)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, uuid.UUID, *github.AppConfig, uuid.UUID) error); ok {
		r1 = rf(ctx, uniqueUuid, app, createdBy)
	} else {
		r1 = ret.Error(1)
	}
...
//   - createdBy uuid.UUID
func (_e *GithubRepositoryMock_Expecter) CreateApp(ctx interface{}, uniqueUuid interface{}, app interface{}, createdBy interface{}) *GithubRepositoryMock_CreateApp_Call {
...
func (_c *GithubRepositoryMock_CreateApp_Call) Run(run func(ctx context.Context, uniqueUuid uuid.UUID, app *github.AppConfig, createdBy uuid.UUID)) *GithubRepositoryMock_CreateApp_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uuid.UUID), args[2].(*github.AppConfig), args[3].(uuid.UUID))
	})
	return _c
}
...
func (_c *GithubRepositoryMock_CreateApp_Call) RunAndReturn(run func(context.Context, uuid.UUID, *github.AppConfig, uuid.UUID) (*ent.GithubApp, error)) *GithubRepositoryMock_CreateApp_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetGithubAppByUUID provides a mock function with given fields: ctx, ID
func (_m *GithubRepositoryMock) GetGithubAppByUUID(ctx context.Context, ID uuid.UUID) (*ent.GithubApp, error) {
	ret := _m.Called(ctx, ID)
	...
	var r0 *ent.GithubApp
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID) (*ent.GithubApp, error)); ok {
		return rf(ctx, ID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID) *ent.GithubApp); ok {
		r0 = rf(ctx, ID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*ent.GithubApp)
...
//   - ctx context.Context
//   - ID uuid.UUID
func (_e *GithubRepositoryMock_Expecter) GetGithubAppByUUID(ctx interface{}, ID interface{}) *GithubRepositoryMock_GetGithubAppByUUID_Call {
...
func (_c *GithubRepositoryMock_GetGithubAppByUUID_Call) Return(_a0 *ent.GithubApp, _a1 error) *GithubRepositoryMock_GetGithubAppByUUID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *GithubRepositoryMock_GetGithubAppByUUID_Call) RunAndReturn(run func(context.Context, uuid.UUID) (*ent.GithubApp, error)) *GithubRepositoryMock_GetGithubAppByUUID_Call {
	_c.Call.Return(run)
	return _c
}
