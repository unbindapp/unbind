...
// GetNamesByTeam provides a mock function for the type ProjectRepositoryMock
func (_mock *ProjectRepositoryMock) GetNamesByTeam(ctx context.Context, tx repository.TxInterface, teamID uuid.UUID) ([]string, error) {
...
// ProjectRepositoryMock_GetNamesByTeam_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetNamesByTeam'
type ProjectRepositoryMock_GetNamesByTeam_Call struct {
	*mock.Call
}
...
//   - tx repository.TxInterface
//   - teamID uuid.UUID
func (_e *ProjectRepositoryMock_Expecter) GetNamesByTeam(ctx any, tx any, teamID any) *ProjectRepositoryMock_GetNamesByTeam_Call {
	return &ProjectRepositoryMock_GetNamesByTeam_Call{Call: _e.mock.On("GetNamesByTeam", ctx, tx, teamID)}
}

func (_c *ProjectRepositoryMock_GetNamesByTeam_Call) Run(run func(ctx context.Context, tx repository.TxInterface, teamID uuid.UUID)) *ProjectRepositoryMock_GetNamesByTeam_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *ProjectRepositoryMock_GetNamesByTeam_Call) Return(strings []string, err error) *ProjectRepositoryMock_GetNamesByTeam_Call {
	_c.Call.Return(strings, err)
	return _c
}

func (_c *ProjectRepositoryMock_GetNamesByTeam_Call) RunAndReturn(run func(ctx context.Context, tx repository.TxInterface, teamID uuid.UUID) ([]string, error)) *ProjectRepositoryMock_GetNamesByTeam_Call {
	_c.Call.Return(run)
	return _c
}
