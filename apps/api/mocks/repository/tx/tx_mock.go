...
// Client provides a mock function for the type TxMock
func (_mock *TxMock) Client() *ent.Client {
	ret := _mock.Called()
...
func (_c *TxMock_Client_Call) Return(client *ent.Client) *TxMock_Client_Call {
...
func (_mock *TxMock) Commit() error {
	ret := _mock.Called()
...
func (_mock *TxMock) Rollback() error {
	ret := _mock.Called()
