...
const wrapperClassName =
  "bg-input focus-within:ring-primary/50 aria-invalid:ring-destructive/50 focus-within:aria-invalid:ring-destructive/50 data-warning:ring-warning/50 focus-within:data-warning:ring-warning/50 flex w-full cursor-text rounded-lg border text-left transition-colors focus-within:ring-1 data-disabled:cursor-not-allowed data-disabled:opacity-50";
