...
function ComboboxChip({ className, ...props }: ComboboxPrimitive.Chip.Props) {
  return (
    <ComboboxPrimitive.Chip
      className={cn(
        "bg-background data-highlighted:ring-primary/8-10 flex max-w-full min-w-0 items-stretch overflow-hidden rounded-lg border data-highlighted:ring-1",
        className,
      )}
      {...props}
    />
...
function ComboboxChipRemove({ className, ...props }: ComboboxPrimitive.ChipRemove.Props) {
  return (
    <ComboboxPrimitive.ChipRemove
      className={cn(
        "text-muted-foreground has-hover:hover:bg-border has-hover:hover:text-foreground active:bg-border active:text-foreground focus-visible:ring-primary/8-10 flex shrink-0 items-center border-l px-2 focus-visible:ring-1 focus-visible:outline-hidden",
        className,
      )}
      {...props}
    />
