        ...
        children={(field) => (
          <div className="flex w-full flex-col items-start gap-2">
            ...
            <div className="text-muted-more-foreground -mt-2 flex w-full items-center justify-start gap-1.25 border-t px-3.25 pt-2.5 pb-2 md:mt-1.25 md:-mb-0.5 md:px-4.25 md:pt-2.5 md:pb-0">
              <InfoIcon className="size-3.5 shrink-0 sm:size-4" />
      ...
      trailing={
        referencesDisabled ? undefined : (
          <Button
            ...
            className="text-muted-foreground focus:ring-primary mt-0.5 mr-0.5 mb-auto rounded-md data-compact:mt-0.75 data-compact:mr-0.75 data-compact:h-7 data-compact:w-7.5 data-compact:rounded"
          >
