...
export function DomainStatusCard({
  ...
  return (
    <div
      ...
      className={cn(
        "group/card data-configured:bg-success/6 data-configured:border-success/12 z-0 flex w-full flex-col items-start justify-start rounded-lg border text-sm select-text",
        className,
      )}
    >
