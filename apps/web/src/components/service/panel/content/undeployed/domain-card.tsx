...
export function DomainStatusCard({
  ...
  return (
    <div
      ...
      className={cn(
        "group/card data-configured:bg-success/2-10 data-configured:border-success/4-10 z-0 flex w-full flex-col items-start justify-start rounded-lg border text-sm select-text",
        className,
      )}
    >
