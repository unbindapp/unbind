...
export default function ServiceGroupCard({
  ...
  return (
    <li
      ...
      {...rest}
    >
      <div className="relative flex w-full flex-col rounded-xl border bg-[radial-gradient(color-mix(in_oklab,var(--border)_50%,transparent)_1px,transparent_1px),radial-gradient(color-mix(in_oklab,var(--border)_50%,transparent)_1px,transparent_1px)] bg-size-[10px_10px] bg-position-[0px_0px,5px_5px]">
