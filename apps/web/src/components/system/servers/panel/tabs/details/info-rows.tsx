      ...
      {rows.map((row) => (
        ...
        >
          <p
            ...
            className="text-muted-foreground group-data-placeholder/list:bg-muted-foreground group-data-placeholder/list:animate-skeleton min-w-0 shrink truncate leading-tight group-data-placeholder/list:rounded-md group-data-placeholder/list:text-transparent data-icon:-ml-0.5"
          >
