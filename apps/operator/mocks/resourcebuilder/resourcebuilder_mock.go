...
// BuildRoutes provides a mock function with no fields
func (_m *ResourceBuilderMock) BuildRoutes() ([]client.Object, error) {
	ret := _m.Called()
...
func (_c *ResourceBuilderMock_BuildRoutes_Call) Return(_a0 []client.Object, _a1 error) *ResourceBuilderMock_BuildRoutes_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
