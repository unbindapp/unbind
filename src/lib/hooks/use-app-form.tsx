  ...
  return (
    <div className={cn("relative flex flex-col", className)}>
      <Input
        ...
        className={cn(
          "relative z-10 w-full data-show-generated:pr-24 data-show-reset:pr-11",
          classNameInput,
        )}
      />
