    ...
    return (
      <div className={cn("flex w-full flex-col", className)}>
        ...
        {showCardType === "auto-generated" && (
          <AutoGeneratedDomainCard className="absolute top-0 -right-1.25 z-10 -translate-y-1/2" />
        )}
      </div>
    );
  }
...
function AutoGeneratedDomainCard({ className }: { className?: string }) {
  return (
    <p
      className={cn(
        "text-muted-foreground bg-background pointer-events-none max-w-1/2 min-w-0 truncate rounded-full border px-1.5 py-0.25 text-xs leading-tight font-semibold",
        className,
      )}
    >
      Auto-generated
