    ...
    return (
      <div className={cn("flex w-full flex-col", className)}>
        ...
        {showCardType === "auto-generated" && (
          <AutoGeneratedDomainIndicator className="absolute top-0 -right-1 z-10 -translate-y-1/2" />
        )}
      </div>
    );
  }
...
function AutoGeneratedDomainIndicator({ className }: { className?: string }) {
  return (
    <p
      className={cn(
        "text-muted-foreground pointer-events-none relative max-w-1/2 min-w-0 truncate text-xs leading-tight font-semibold",
        className,
      )}
    >
      Generated
