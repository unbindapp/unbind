...
export default function SettingsTabBar({ tabs }: Props) {
  ...
  return (
    <div className="bg-background sticky top-0 left-0 z-50 flex max-h-full w-full flex-row items-center overflow-auto border-b sm:top-[calc(5.75rem+2px)] md:max-h-[calc(100svh-6rem)] md:w-52 md:flex-col md:items-start md:justify-start md:border-0 lg:top-[calc(3rem-1px)] lg:max-h-[calc(100svh-3rem-1px)]">
